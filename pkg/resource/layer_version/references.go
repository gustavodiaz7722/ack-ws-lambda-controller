...
func (rm *resourceManager) EnsureReferences(
	...
	if desiredKO.Spec.Content != nil {
		if desiredKO.Spec.Content.S3BucketRef != nil {
			if latestKO.Spec.Content == nil {
				latestKO.Spec.Content = &svcapitypes.LayerVersionContentInput{}
			}
			if latestKO.Spec.Content.S3BucketRef == nil {
